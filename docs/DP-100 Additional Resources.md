...
6.   [Set up AML Visual Studio Code extension](https://docs.microsoft.com/en-us/azure/machine-learning/tutorial-setup-vscode-extension)
7. [Connect to an AML compute instance in VS Code](https://docs.microsoft.com/en-us/azure/machine-learning/how-to-set-up-vs-code-remote)
...
3. [ML Algorithm Cheat Sheet for AML Designer](https://docs.microsoft.com/en-us/azure/machine-learning/algorithm-cheat-sheet)
4. [How to select algorithms for Azure Machine Learning](https://docs.microsoft.com/en-us/azure/machine-learning/how-to-select-algorithms)
5. [Algorithm & module reference for AML designer](https://docs.microsoft.com/en-us/azure/machine-learning/algorithm-module-reference/module-reference)
6. [Evaluate Model - main metrics explained](https://docs.microsoft.com/en-us/azure/machine-learning/algorithm-module-reference/evaluate-model)
7. [Deploying a Deep Learning inference with GPU](https://docs.microsoft.com/en-us/azure/machine-learning/how-to-deploy-inferencing-gpus)
...
4. [MLflow Tracking for ML experiments - AML](https://docs.microsoft.com/en-us/azure/machine-learning/how-to-use-mlflow) 
5. [Azure Machine Learning training run documentation](https://docs.microsoft.com/azure/machine-learning/how-to-set-up-training-targets)
...
3. [Secure data access in AML](https://docs.microsoft.com/en-us/azure/machine-learning/concept-data)
...
3. [Trigger CI/CD workflows on AML events (event grid)](https://docs.microsoft.com/en-us/azure/machine-learning/how-to-use-event-grid)
4. [Set up authentication for AML resourses](https://docs.microsoft.com/en-us/azure/machine-learning/how-to-setup-authentication)
...
4. [CI/CD with Azure Pipelines](https://docs.microsoft.com/azure/devops/pipelines/targets/azure-machine-learning)
...
4. [Azure Machine Learning responsible ML](https://docs.microsoft.com/azure/machine-learning/concept-responsible-ml)
